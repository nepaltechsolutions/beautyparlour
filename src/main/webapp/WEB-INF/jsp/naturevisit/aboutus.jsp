								...
								<ul>
									...
									<li class="menu-item-has-children current-menu-item"><a href="javascript:void(0);">pages</a>
										<ul class="sub-menu">
											<li><a href="/naturevisit/faqs">FAQ’s</a></li>
											<li><a href="/naturevisit/packages">Table</a></li>
											<li class="current-menu-item"><a href="/naturevisit/aboutus">About Us</a></li>
											<li><a href="/naturevisit/contactus">Contact us</a></li>
											<li><a href="/naturevisit/billingdetail">Billing Detail</a></li>
											<li><a href="/naturevisit/404error">404 Error</a></li>
											<li><a href="/naturevisit/comingsoon">Coming Soon</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div id="tg-guidesslider" class="tg-guidesslider tg-guides owl-carousel">
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/Guides/img-01.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											...
											<ul class="tg-socialicons">
												<li><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/icons/icon-05.png" alt="image destinations"></a></li>
												<li><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/icons/icon-06.png" alt="image destinations"></a></li>
												<li><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/icons/icon-07.png" alt="image destinations"></a></li>
											</ul>
										</div>
										<div class="tg-description">
								...
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/Guides/img-02.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											<h3><a href="javascript:void(0);">Martin Blake</a></h3>
											<h4><a href="javascript:void(0);">Adventure Master</a></h4>
								...
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/Guides/img-03.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											<h3><a href="javascript:void(0);">Martin Blake</a></h3>
											<h4><a href="javascript:void(0);">Adventure Master</a></h4>
