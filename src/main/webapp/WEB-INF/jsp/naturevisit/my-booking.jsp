								...
								<aside id="tg-sidebar" class="tg-sidebar">
									<div class="tg-widget tg-widgetdashboard">
										...
										<div class="tg-widgetcontent">
											<ul>
												<li><a href="/naturevisit/dashboard"><i class="icon-user"></i><span>Dashboard</span></a></li>
												...
												<li class="selected"><a href="my-booking.html"><i class="icon-basket3"></i><span>My Booking</span></a></li>
											...
											<div class="tg-dashboardcontent">
												<div class="tg-content">
													<table class="table table-responsive">
														...
														<tbody>
															<tr>
																<td data-title="tour name">Best of Canada Tours and Travel</td>
																<td data-title="tour date">June 9, 2017</td>
																<td data-title="total"><strong>$3,924.00</strong></td>
																<td class="tg-status" data-title="status">Processing</td>
