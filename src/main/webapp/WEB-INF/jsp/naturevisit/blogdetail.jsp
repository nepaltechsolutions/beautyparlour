	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
		...
		*************************************-->
		<!--************************************
				Inner Banner Start
		*************************************-->
		<section class="tg-parallax tg-innerbanner tg-innerbannervtwo" data-appear-top-offset="600" data-parallax="scroll" data-image-src="${pageContext.request.contextPath}/naturevisitFiles/images/parallax/bgparallax-08.jpg">
								...
								<div class="tg-detailbox">
									...
									<div class="tg-description">
										...
										<figure class="tg-blogdetailimg">
											<img src="${pageContext.request.contextPath}/naturevisitFiles/images/blogdetail-img.jpg" alt="image description">
										</figure>
									</div>
								</div>
								<div class="tg-detailbox">
									...
									<ul id="tg-comments" class="tg-comments">
										<li>
											<div class="tg-comment">
												<figure><img src="${pageContext.request.contextPath}/naturevisitFiles/images/avatars/img-03.jpg" alt="image description"></figure>
