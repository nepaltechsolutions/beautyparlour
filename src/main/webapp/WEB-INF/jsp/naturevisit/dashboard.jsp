								...
								<aside id="tg-sidebar" class="tg-sidebar">
									<div class="tg-widget tg-widgetdashboard">
										...
										<div class="tg-widgetcontent">
											<ul>
												<li class="selected"><a href="/naturevisit/dashboard"><i class="icon-user"></i><span>Dashboard</span></a></li>
									...
									<div class="tg-dashboard">
										<div class="tg-box tg-profile">
											...
											<div class="tg-dashboardcontent">
												<figure><img src="${pageContext.request.contextPath}/naturevisitFiles/images/authorimg.jpg" alt="image description"></figure>
