...
<body class="tg-home tg-homevfive">
	<!--[if lt IE 8]>
									...
									<ul>
										<li class="menu-item-has-children current-menu-item"><a href="javascript:void(0);">Home</a>
											<ul class="sub-menu">
												...
												<li><a href="/naturevisit/indexv3">Home ~ Creative</a></li>
												<li><a href="/naturevisit/indexv4">Home ~ Simple</a></li>
												<li class="current-menu-item"><a href="/naturevisit/indexv5">Home ~ Video</a></li>
											</ul>
										</li>
										<li><a href="/naturevisit/destinations">destinations</a></li>
		...
		*************************************-->
		<div id="tg-homebannerslider" class="tg-homebannerslider tg-haslayout">
			<div class="tg-homeslider tg-homebannervtwo tg-haslayout">
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-08.jpg" data-vide-options="position: 0% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="tg-slidercontent">
										...
										<h1>Planning a Trip to Africa?</h1>
										<h2>Your Dream Trip is Our Mission</h2>
									</div>
								</div>
							</div>
						</div>
