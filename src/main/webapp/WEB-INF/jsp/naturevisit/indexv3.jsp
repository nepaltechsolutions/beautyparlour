								...
								<ul>
									<li class="menu-item-has-children current-menu-item"><a href="javascript:void(0);">Home</a>
										<ul class="sub-menu">
											<li><a href="/naturevisit/index">Home ~ Modern</a></li>
											<li><a href="/naturevisit/indexv2">Home ~ Full Screen</a></li>
											<li class="current-menu-item"><a href="/naturevisit/indexv3">Home ~ Creative</a></li>
											<li><a href="/naturevisit/indexv4">Home ~ Simple</a></li>
											<li><a href="/naturevisit/indexv5">Home ~ Video</a></li>
										</ul>
									</li>
		...
		*************************************-->
		<div id="tg-homebannerslider" class="tg-homebannerslider tg-haslayout">
			<div id="tg-homesliderfull" class="tg-homeslider tg-homesliderfull tg-homeslidervthree owl-carousel tg-haslayout">
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-01.jpg" data-vide-options="position: 50% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
				...
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-02.jpg" data-vide-options="position: 50% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-03.jpg" data-vide-options="position: 50% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-04.jpg" data-vide-options="position: 50% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-05.jpg" data-vide-options="position: 50% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-06.jpg" data-vide-options="position: 50% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
