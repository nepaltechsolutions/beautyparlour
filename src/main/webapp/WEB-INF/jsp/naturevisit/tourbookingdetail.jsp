	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
									...
									<li class="menu-item-has-children current-menu-item"><a href="javascript:void(0);">pages</a>
										<ul class="sub-menu">
											...
											<li class="menu-item-has-children current-menu-item">
												...
												<ul class="sub-menu">
													<li><a href="/naturevisit/tourcatagory">Tour Catagory</a></li>
													<li class="current-menu-item"><a href="/naturevisit/tourbookingdetail">Tour Detail</a></li>
													<li><a href="/naturevisit/tourpaymentdetail">Tour Payment</a></li>
												</ul>
											</li>
										</ul>
		...
		*************************************-->
		<!--************************************
				Inner Banner Start
		*************************************-->
		<div class="tg-parallax tg-innerbanner" data-appear-top-offset="600" data-parallax="scroll" data-image-src="${pageContext.request.contextPath}/naturevisitFiles/images/parallax/bgparallax-06.jpg">
							...
							<div class="tg-tourbookingdetail">
								<div class="tg-bookinginfo">
									...
									<div class="tg-refundshare">
										<div class="tg-refund">
											<figure><img src="${pageContext.request.contextPath}/naturevisitFiles/images/img-03.jpg" alt="image description"></figure>
																	...
																	<div class="tg-review">
																		<div class="tg-author">
																			<figure class="tg-authorimg">
																				<img src="${pageContext.request.contextPath}/naturevisitFiles/images/avatars/img-01.jpg" alt="image description">
																			</figure>
														...
														<li>
															<figure>
																<a href="images/gallery/img-01.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-01.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-02.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-02.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-03.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-03.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-04.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-04.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-05.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-05.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-06.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-06.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-07.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-07.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-08.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-08.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
														<li>
															<figure>
																<a href="images/gallery/img-09.jpg" data-rel="prettyPhoto[instagram]">
																	<img src="${pageContext.request.contextPath}/naturevisitFiles/images/gallery/img-09.jpg" alt="image decruoton">
																</a>
															</figure>
														</li>
													</ul>
