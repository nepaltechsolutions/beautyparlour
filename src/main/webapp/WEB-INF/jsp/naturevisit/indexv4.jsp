									...
									<ul>
										<li class="menu-item-has-children current-menu-item"><a href="javascript:void(0);">Home</a>
											<ul class="sub-menu">
												...
												<li><a href="/naturevisit/indexv2">Home ~ Full Screen</a></li>
												<li><a href="/naturevisit/indexv3">Home ~ Creative</a></li>
												<li class="current-menu-item"><a href="/naturevisit/indexv4">Home ~ Simple</a></li>
												<li><a href="/naturevisit/indexv5">Home ~ Video</a></li>
											</ul>
										</li>
										<li><a href="/naturevisit/destinations">destinations</a></li>
		...
		*************************************-->
		<div id="tg-homebannerslider" class="tg-homebannerslider tg-haslayout">
			<div class="tg-homeslider tg-homebanner tg-haslayout">
				<figure class="item" data-vide-bg="poster: ${pageContext.request.contextPath}/naturevisitFiles/images/slider/img-07.jpg" data-vide-options="position: 0% 50%">
					<figcaption>
						<div class="container">
							<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="tg-ourpartners tg-ourpartnersvtwo">
								<ul class="tg-partners">
									<li><figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/partners/img-06.png" alt="image destinations"></a></figure></li>
									<li><figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/partners/img-07.png" alt="image destinations"></a></figure></li>
									<li><figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/partners/img-07.png" alt="image destinations"></a></figure></li>
									<li><figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/partners/img-09.png" alt="image destinations"></a></figure></li>
									<li><figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/naturevisitFiles/images/partners/img-10.png" alt="image destinations"></a></figure></li>
								</ul>
							</div>
						</div>
					</div>
