								...
								<ul>
									...
									<li class="menu-item-has-children current-menu-item"><a href="javascript:void(0);">pages</a>
										<ul class="sub-menu">
											...
											<li><a href="/naturevisit/aboutus">About Us</a></li>
											<li><a href="/naturevisit/contactus">Contact us</a></li>
											<li class="current-menu-item"><a href="/naturevisit/billingdetail">Billing Detail</a></li>
											<li><a href="/naturevisit/404error">404 Error</a></li>
											<li><a href="/naturevisit/comingsoon">Coming Soon</a></li>
											<li><a href="/naturevisit/cart">cart</a></li>
											...
											<div id="tg-accordion" class="tg-accordion" role="tablist" aria-multiselectable="true">
												...
												<div class="tg-panel">
													<h4 class="tg-radio">
														...
														<img src="${pageContext.request.contextPath}/naturevisitFiles/images/paypal.jpg" alt="image description">
													</h4>
													<div class="tg-panelcontent">
														<div class="tg-description">
															<p>Maecenas sed diam eget risus varius blandit sit amet non magna. Vivamus sagittis lacus vel augue Sed non mauris vitae;erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo.</p>
												...
												<div class="tg-panel">
													<h4 class="tg-radio">
														...
														<img src="${pageContext.request.contextPath}/naturevisitFiles/images/visastrip.jpg" alt="image description">
													</h4>
													<div class="tg-panelcontent">
														<div class="tg-description">
															<p>Maecenas sed diam eget risus varius blandit sit amet non magna. Vivamus sagittis lacus vel augue Sed non mauris vitae;erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo.</p>
