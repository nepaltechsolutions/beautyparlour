    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Contact Us Messages</div>
        <div class="card-body">
          <div class="table-responsive">
          
          
									<table id="contactMessages" class="display"
										style="width: 100%">
										...
										<tbody>
											<c:forEach items="${contactMessages}" var="messages"
												varStatus="status">

												<tr>
													<td><center>${messages.fullName}</center></td>
													<td><center>${messages.email}</center></td>
													<td><center>${messages.subject}</center></td>
													<td><center>${messages.message}</center></td>
													<td><center>${messages.contactStatus}</center></td>
												</tr>
